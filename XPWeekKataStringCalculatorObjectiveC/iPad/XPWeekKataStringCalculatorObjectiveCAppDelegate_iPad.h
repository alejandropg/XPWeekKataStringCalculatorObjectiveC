...
//
//
//  XPWeekKataStringCalculatorObjectiveCAppDelegate_iPad.h
...
@interface XPWeekKataStringCalculatorObjectiveCAppDelegate_iPad : XPWeekKataStringCalculatorObjectiveCAppDelegate
