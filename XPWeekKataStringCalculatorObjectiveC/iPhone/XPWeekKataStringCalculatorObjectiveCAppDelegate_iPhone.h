...
//
//
//  XPWeekKataStringCalculatorObjectiveCAppDelegate_iPhone.h
...
@interface XPWeekKataStringCalculatorObjectiveCAppDelegate_iPhone : XPWeekKataStringCalculatorObjectiveCAppDelegate
