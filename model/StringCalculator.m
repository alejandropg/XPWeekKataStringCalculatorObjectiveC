...
- (id)initWithTokenizer:(id<Tokenizer>)aTokenizer {
    self = [super init];
    if (self) {
...
- (id)init {
	@throw [NSException exceptionWithName:@"UnsupportedOperationException" reason:@"You have to call initWithTokenizer" userInfo:nil];
}
...
- (int)add:(NSString *)numbers {
	NSArray *chunks = [tokenizer tokenize: numbers];
